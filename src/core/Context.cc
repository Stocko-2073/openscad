...
boost::optional<CallableFunction> Context::lookup_function(const Identifier& name,
...
boost::optional<InstantiableModule> Context::lookup_module(const Identifier& name,
                                                           const Location& loc) const
{
  if (name.isConfigVariable()) {
